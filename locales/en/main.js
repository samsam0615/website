...
export default {
    ...
    homepage : {
        ...
        area1 : {
            title: 'Latest News',
            content1: 'Course from Education Bureau (EDB) STEAM Education Learning, Teaching and Assessment Series: Hands-on workshop on the Applications of “Module on Artificial Intelligence for Junior Secondary Level” ',
    ...
    contact : {
        'content' : 'Hotline：6437 3924 Email Address：info{"@"}eduairhk.com',
    ...
    news : {
        ...
        Area2 : {
            title :'Hands-on workshop on the Applications of “Module on Artificial Intelligence for Junior Secondary Level” (A total of 20 sessions)',
            subtitle : 'Hong Kong EDB STEAM Education Learning, Teaching and Assessment Series',
            date : 'Starting from September, 2023'
        },

        Area3 : {
            title :'“Crisis Resolution” Workshop',
   ...
   icar : {
        description: "iCar is an AI teaching kit specifically designed for junior secondary school students，let them able to learn AI using Blockly programming",
        ...
        navbar: [
            "What is iCar？", "How to use iCar？", "Moral Dilemma", "Face Following", "Line Tracking", "Food Delivery", "Resource Summary"
        ],
        ...
        Area3 : {
            ...
            question: ['What machine learning method does iCar use？','When collecting data, what should we pay attention to and why？','Besides evading kids and evading elderlies, does iCar have a third option？']

        },

        Area4 : {
            content: ["Why can self-driving cars recognize faces and follow specified faces？","How does a self-driving car learn this skill? Let'’s experiment with iCar to find out！"],
            question: ['How does iCar learn to recognize specific faces？','Does the performance of iCar get affected when recognizing the same face from different angles? Why?','What are the benefits and limitations of applying this technology in real-life situations？']
        },

        Area5 : {
            content : ["Self-driving cars can move based on various colored lines, both dashed and solid, to follow the correct path.","How is this achieved? Let'’s experiment with iCar to find out！"],
            question : ["Is there a difference in iCar's performance when following hand-drawn lines and printed lines？","Does the thickness, size, shape, etc., of the lines affect iCar's movement？","What is the real-life application of iCar's line tracking technology? Where can it be applied？"]
        },
    ...
    iport : {
        ...
        Area3 : {
            ...
            question : ['Is it possible to allow only authorized individuals to pass through the restricted area gate instead of triggering the alarm system for anyone who passes by？','Why are the alarm system triggered after dark? How to avoid false triggers？' ,'When training the model for the "someone is present" scenario, using pictures of only classmate A passing through the restricted area, is there enough data for identifying the presence of people？']
        },

        Area4 : {
            title : ['Tutorial','Experiment Demonstration'],
            material_needed : 'Materials needed：',
            ...
            question : ['What are the differences between using image recognition for gesture control and traditional gesture recognition techniques？','How can data collection be optimized to improve the control of the car？']
        ...
        Area5 : {
            ...
            question : ['How can the accuracy of voice control be improved？','Noise may affect voice recognition accuracy, leading to potential false triggers. How can we reduce the impact of noise in this context？']
        }
    ...
    event_2_vue : {
        ...
        date : '17-18 August 2023',
        location : 'The Chinese University of Hong Kong (CUHK)',
        content : 'EduAIR, in collaboration with CUHK Jockey Club AI for the Future Project, co-organized an AI Education and Exploration Lab Open Day at CUHK on 17 and 18 August 2023. Over 20 different AI robots were showcased for the public, including AI oil painting robot, AI calligraphy robot, AI hoverball robot, AI piano duet, and more. Additionally, four “iCar Expert” workshops were held, engaging over 90 participants using our developed iCar as teaching kits to successfully complete programming and logical programming design of an AI experiment (Face Following Experiment).'
    },
