<template>
  <Head>
    <Title>iPort</Title>
    <Meta name="description" content="iPort是為實現AI物聯網（AIoT）而設的AI教學套件，讓學生輕鬆創建不同AI機械項目。"/>
  </Head>
  ...
  <div class="pageContent-container" v-show="isShowContent" style="z-index: 0; flex-direction: column; justify-content: flex-start; align-items: flex-start; padding: 30px; overflow: visible; max-width: 1200px; width: 100%" >
    <div class="page-content" style="width: 100%" ref="content">
      ...
      <div class="text-content font-small">
        iPort是由中大團隊開發的AI教學套件。師生可省略複雜的硬件搭綫步驟，使用iPort編程平台，套用於Teachable Machine訓練的AI模型，無須編程即可實現AI物聯網（AIoT） ， 建立不同的AI項目。
      ...
      <div class="text-content font-small" >
        ...
        <video muted controls style="width: 100%; max-width: 750px">
            <source :src="'https://video.eduairhk.com/iport6.mp4'" type="video/mp4">
        </video>
        <video muted controls style="width: 100%; max-width: 750px">
            <source :src="'https://video.eduairhk.com/iport7.mp4'" autostart="false" type="video/mp4">
        </video>
      </div>
    </div>
  </div>
