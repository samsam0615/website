...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="pageContent-container" style="${ssrRenderStyle({ "flex-direction": "row", "justify-content": "flex-start", "align-items": "flex-start", "padding": "30px", "overflow": "visible" })}" data-v-65d4cb36>`);
  ...
  _push(`<div class="page-content" data-v-65d4cb36><span data-v-65d4cb36>CUHK iPort\u662F\u751A\u9EBD\uFF1F</span><div data-v-65d4cb36> CUHK iPort\u662F\u7531\u4E2D\u5927\u5718\u968A\u958B\u767C\u7684AI\u6559\u5B78\u5957\u4EF6\u3002\u5E2B\u751F\u53EF\u7701\u7565\u8907\u96DC\u7684\u786C\u4EF6\u642D\u7DAB\u6B65\u9A5F\uFF0C\u4F7F\u7528iPort\u7DE8\u7A0B\u5E73\u53F0\uFF0C\u5957\u7528\u65BCTeachable Machine\u8A13\u7DF4\u7684AI\u6A21\u578B\uFF0C\u7121\u9808\u7DE8\u7A0B\u5373\u53EF\u5BE6\u73FEAI\u7269\u806F\u7DB2\uFF08AIoT\uFF09 \uFF0C \u5EFA\u7ACB\u4E0D\u540C\u7684AI\u9805\u76EE\u3002 </div><img${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "position": "relative", "max-width": "500px", "width": "100%", "margin-top": "5px" })}" data-v-65d4cb36><span data-v-65d4cb36>CUHK iPort\u80FD\u505A\u751A\u9EBC\uFF1F</span><div style="${ssrRenderStyle({ "display": "flex", "gap": "15px", "flex-wrap": "wrap" })}" data-v-65d4cb36>`);
  ...
  _push(`</div><span data-v-65d4cb36>\u5982\u4F55\u4F7F\u7528CUHK iPort\uFF1F</span><div style="${ssrRenderStyle({ "display": "flex", "gap": "20px", "flex-direction": "column" })}" data-v-65d4cb36>`);
  _push(ssrRenderComponent(_component_OrangeVideo, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<a class="orangeBtn" href="https://teachablemachine.withgoogle.com/" target="_blank" data-v-65d4cb36${_scopeId}>\u524D\u5F80Teachable Machine</a>`);
      } else {
        return [
          createVNode("a", {
            class: "orangeBtn",
  ...
  _push(ssrRenderComponent(_component_OrangeVideo, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<a class="orangeBtn" href="https://iport.eduairhk.com/" target="_blank" data-v-65d4cb36${_scopeId}>\u524D\u5F80CUHK iPort\u7DE8\u7A0B\u5E73\u53F0</a>`);
      } else {
        return [
          createVNode("a", {
            class: "orangeBtn",
  ...
  _push(`</div><span data-v-65d4cb36>CUHK iPort\u7DE8\u7A0B\u5E73\u53F0</span><a href="https://iport.eduairhk.com" target="_blank" class="btn" data-v-65d4cb36>\u524D\u5F80 iPort\u7DE8\u7A0B\u5E73\u53F0</a><span data-v-65d4cb36>CUHK iPort\u5BE6\u7528\u8CC7\u6E90\u7E3D\u532F</span><div data-v-65d4cb36> \u5373\u5C07\u63A8\u51FA </div></div></div><!--]-->`);
}
...
const cuhkIport = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-65d4cb36"]]);

export { cuhkIport as default };
//# sourceMappingURL=cuhk-iport-f20b2308.mjs.map
