...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_EventTemplate, {
    ...
    location: "\u9999\u6E2F\u4E2D\u6587\u5927\u5B78",
    images: ["/event/event3/2.jpg", "/event/event3/1.jpg", "/event/event3/3.jpg", "/event/event3/5.jpg", "/event/event3/4.jpg"]
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/event/3.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _3 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { _3 as default };
//# sourceMappingURL=3-da69b7f6.mjs.map
