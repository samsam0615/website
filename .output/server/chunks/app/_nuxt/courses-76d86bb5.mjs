...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div class="pageContent-container" style="${ssrRenderStyle({ "max-width": "100%", "width": "1024px", "justify-content": "flex-start", "min-height": "100%", "align-items": "center" })}" data-v-22854eaf><div class="banner" data-v-22854eaf><label class="title font-big" data-v-22854eaf> \u5230\u6821\u8AB2\u7A0B </label></div><div class="text" style="${ssrRenderStyle({ "padding": "60px" })}" data-v-22854eaf>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div style="${ssrRenderStyle({ "margin-top": "30px", "padding": "20px", "font-size": "20px", "background": "orange", "color": "white", "border-radius": "10px", "cursor": "pointer", "display": "flex", "justify-content": "center", "min-width": "max-content" })}" data-v-22854eaf${_scopeId}> \u806F\u7D61\u6211\u5011\u2002\u77AD\u89E3\u66F4\u591A </div>`);
      } else {
        return [
...
const courses = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-22854eaf"]]);

export { courses as default };
//# sourceMappingURL=courses-76d86bb5.mjs.map
