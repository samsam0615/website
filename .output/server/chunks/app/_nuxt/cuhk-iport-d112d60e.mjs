...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<!--[--><div class="container pc" data-v-8c54a736><div style="${ssrRenderStyle({ "height": "300px", "border-radius": "20px", "padding": "20px 0", "display": "flex", "flex-direction": "column", "border": "1px solid #c0c0c0", "background": "orange" })}" data-v-8c54a736><span class="${ssrRenderClass([{ active: $data.id == 0 }, "font-small"])}" data-v-8c54a736>1. \u8A13\u7DF4AI\u6A21\u578B\u53CA\u751F\u6210\u9023\u7D50</span><span class="${ssrRenderClass([{ active: $data.id == 1 }, "font-small"])}" data-v-8c54a736>2. \u4E0A\u8F09\u6A21\u578B\u81F3\u7DE8\u7A0B\u5E73\u53F0</span><span class="${ssrRenderClass([{ active: $data.id == 2 }, "font-small"])}" data-v-8c54a736>3. \u64CD\u4F5CCUHK iPort\u6216\u6A21\u64EC\u5668</span></div><div style="${ssrRenderStyle({ "display": "flex", "justify-content": "center", "align-items": "center", "padding": "0 20px" })}" data-v-8c54a736><div style="${ssrRenderStyle({ "position": "relative", "width": "550px", "height": "300px", "background": "white" })}" data-v-8c54a736><iframe${ssrRenderAttr("src", $data.src[$data.id])} style="${ssrRenderStyle({ "border": "none", "position": "absolute", "top": "0", "left": "0", "height": "100%", "width": "100%", "border-radius": "10px" })}" allow="accelerometer; gyroscope; autoplay; encrypted-media; picture-in-picture;" allowfullscreen="true" data-v-8c54a736></iframe></div></div></div><div class="container mobile" data-v-8c54a736><div style="${ssrRenderStyle({ "width": "100%", "border-radius": "20px", "padding": "20px 0", "display": "flex", "flex-direction": "column", "border": "1px solid #c0c0c0", "background": "orange" })}" data-v-8c54a736><span class="${ssrRenderClass([{ active: $data.id == 0 }, "font-small"])}" data-v-8c54a736>1. \u8A13\u7DF4AI\u6A21\u578B\u53CA\u751F\u6210\u9023\u7D50 <div style="${ssrRenderStyle([
    $data.id == 0 ? null : { display: "none" },
    { "position": "relative", "width": "100%", "height": "300px" }
  ])}" data-v-8c54a736><iframe${ssrRenderAttr("src", $data.src[0])} style="${ssrRenderStyle({ "border": "none", "position": "absolute", "top": "0", "left": "0", "height": "100%", "width": "100%", "border-radius": "10px" })}" allow="accelerometer; gyroscope; autoplay; encrypted-media; picture-in-picture;" allowfullscreen="true" preload="true" data-v-8c54a736></iframe></div></span><span class="${ssrRenderClass([{ active: $data.id == 1 }, "font-small"])}" data-v-8c54a736>2. \u4E0A\u8F09\u6A21\u578B\u81F3\u7DE8\u7A0B\u5E73\u53F0 <div style="${ssrRenderStyle([
    $data.id == 1 ? null : { display: "none" },
    { "position": "relative", "width": "100%", "height": "300px" }
  ])}" data-v-8c54a736><iframe${ssrRenderAttr("src", $data.src[1])} style="${ssrRenderStyle({ "border": "none", "position": "absolute", "top": "0", "left": "0", "height": "100%", "width": "100%", "border-radius": "10px" })}" allow="accelerometer; gyroscope; autoplay; encrypted-media; picture-in-picture;" allowfullscreen="true" preload="true" data-v-8c54a736></iframe></div></span><span class="${ssrRenderClass([{ active: $data.id == 2 }, "font-small"])}" data-v-8c54a736>3. \u64CD\u4F5CCUHK iPort\u6216\u6A21\u64EC\u5668 <div style="${ssrRenderStyle([
    $data.id == 2 ? null : { display: "none" },
    { "position": "relative", "width": "100%", "height": "300px" }
  ])}" data-v-8c54a736><iframe${ssrRenderAttr("src", $data.src[2])} style="${ssrRenderStyle({ "border": "none", "position": "absolute", "top": "0", "left": "0", "height": "100%", "width": "100%", "border-radius": "10px" })}" allow="accelerometer; gyroscope; autoplay; encrypted-media; picture-in-picture;" allowfullscreen="true" preload="true" data-v-8c54a736></iframe></div></span></div></div><!--]-->`);
}
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-8c54a736"]]);
const _sfc_main = {
  name: "CUHK-iPort",
  data() {
    return {
...
//# sourceMappingURL=cuhk-iport-d112d60e.mjs.map
