...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="pageContent-container"><div class="text-container" onclick=""><label class="subTitle">iShare</label><br><div class="pageDescription">\u82E6\u82E6\u641C\u5C0B\u7DB2\u4E0A\u514D\u8CBB\u7684AI \u5B78\u7FD2\u8CC7\u6E90\uFF0C\u597D\u73A9\u4E4B\u9918\u53C8\u4E0D\u60F3\u8A3B\u518A\u767B\u8A18\uFF1FiShare\u5E6B\u4F60\u8F15\u9B06\u6109\u5FEB\u9AD4\u9A57AI\u7684\u5947\u5999\u3002</div><br><br><div class="resourceContainer"><div class="resourceType"><label class="${ssrRenderClass({ active: $data.externalJson != null && $data.externalJson["vision"] == $data.focusClass })}">\u8996\u89BA</label><label class="${ssrRenderClass({ active: $data.externalJson != null && $data.externalJson["hear"] == $data.focusClass })}">\u807D\u89BA</label><label class="${ssrRenderClass({ active: $data.externalJson != null && $data.externalJson["speak"] == $data.focusClass })}">\u8A9E\u97F3</label><label class="${ssrRenderClass({ active: $data.externalJson != null && $data.externalJson["read"] == $data.focusClass })}">\u7406\u89E3</label><label class="${ssrRenderClass({ active: $data.externalJson != null && $data.externalJson["create"] == $data.focusClass })}">\u5275\u4F5C</label><label class="${ssrRenderClass({ active: $data.externalJson != null && $data.externalJson["advance"] == $data.focusClass })}">\u9032\u968E</label></div><div class="resourceSelector unselectable">`);
...
const ishare = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { ishare as default };
//# sourceMappingURL=ishare-9c6a347e.mjs.map
