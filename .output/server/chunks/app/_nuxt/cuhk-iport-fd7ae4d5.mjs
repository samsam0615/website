...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="pageContent-container" style="${ssrRenderStyle({ "z-index": "0", "flex-direction": "column", "justify-content": "flex-start", "align-items": "flex-start", "padding": "30px", "overflow": "visible", "width": "1000px", "max-width": "100%" })}" data-v-a78f4165><div class="page-content" data-v-a78f4165><span class="title" data-v-a78f4165>CUHK iPort</span><div class="text-content" style="${ssrRenderStyle({ "display": "flex", "justify-content": "center", "width": "100%" })}" data-v-a78f4165>`);
  _push(ssrRenderComponent(_component_iPortImage, null, null, _parent));
  _push(`</div><span class="title" data-v-a78f4165>\u529F\u80FD\u4ECB\u7D39</span><div class="text-content" data-v-a78f4165> CUHK iPort\u662F\u7531\u4E2D\u5927\u5718\u968A\u958B\u767C\u7684AI\u6559\u5B78\u5957\u4EF6\u3002\u5E2B\u751F\u53EF\u7701\u7565\u8907\u96DC\u7684\u786C\u4EF6\u642D\u7DAB\u6B65\u9A5F\uFF0C\u4F7F\u7528iPort\u7DE8\u7A0B\u5E73\u53F0\uFF0C\u5957\u7528\u65BCTeachable Machine\u8A13\u7DF4\u7684AI\u6A21\u578B\uFF0C\u7121\u9808\u7DE8\u7A0B\u5373\u53EF\u5BE6\u73FEAI\u7269\u806F\u7DB2\uFF08AIoT\uFF09 \uFF0C \u5EFA\u7ACB\u4E0D\u540C\u7684AI\u9805\u76EE\u3002 `);
  _push(ssrRenderComponent(_component_nuxt_img, {
    src: "iportDesc6.png",
    style: { "width": "100%", "max-width": "900px" }
  }, null, _parent));
  _push(`</div><span class="title" data-v-a78f4165>\u4F7F\u7528\u8AAA\u660E</span><div class="text-content" data-v-a78f4165>`);
  _push(ssrRenderComponent(_component_iPortVideoPlayer, null, null, _parent));
  _push(`</div><span class="title" data-v-a78f4165>\u5BE6\u9A57\u7BC4\u4F8B</span><div class="text-content" style="${ssrRenderStyle({ "max-width": "100%" })}" data-v-a78f4165>`);
  _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
  _push(`</div><span class="title" data-v-a78f4165>\u7DE8\u7A0B\u5E73\u53F0</span><div class="text-content" data-v-a78f4165><a href="https://iport.eduairhk.com" target="_blank" class="btn" data-v-a78f4165>\u524D\u5F80CUHK iPort\u7DE8\u7A0B\u5E73\u53F0</a></div><span class="title" data-v-a78f4165>\u5BE6\u7528\u8CC7\u6E90\u7E3D\u532F</span><div class="text-content" data-v-a78f4165> \u5373\u5C07\u63A8\u51FA </div></div></div><!--]-->`);
}
...
const cuhkIport = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-a78f4165"]]);

export { cuhkIport as default };
//# sourceMappingURL=cuhk-iport-fd7ae4d5.mjs.map
