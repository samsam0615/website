...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "staff-container" }, _attrs))} data-v-145481bb><div class="staff-image-container" data-v-145481bb><img${ssrRenderAttr("src", $props.image)} data-v-145481bb></div><div class="staff-description-container" data-v-145481bb><label class="subTitle staffSubTitle font-middle" style="${ssrRenderStyle({ "border-bottom": "3px solid " + $props.color })}" data-v-145481bb>${ssrInterpolate($props.title)} <a${ssrRenderAttr("href", $props.youtube)} target="_blank" data-v-145481bb>`);
  if ($props.youtube) {
    _push(`<img${ssrRenderAttr("src", _imports_0)} data-v-145481bb>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</a></label><div class="description" data-v-145481bb>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-145481bb"]]);
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div class="pageContent-container"><div class="text-container" style="${ssrRenderStyle({ "width": "100%", "padding": "20px" })}"><label class="pageTitle font-big">\u8463\u4E8B\u5C40\u6210\u54E1</label><div class="pageDescription font-small">EduAIR\u7531\u4E00\u773E\u5177\u8C50\u5BCC\u79D1\u6280\u6559\u80B2\u7D93\u9A57\u7684\u7814\u7A76\u8005\u7D44\u6210\uFF0C\u81F4\u529B\u63A8\u52D5\u9999\u6E2FAI/STEAM\u6559\u80B2\u767C\u5C55\u3002</div></div><div class="text-container" style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "padding": "0 0 10px 0", "justify-content": "space-around", "flex-wrap": "wrap", "flex": "1" })}">`);
  ...
  _push(`</div><div class="text-container" style="${ssrRenderStyle({ "width": "100%" })}"><label class="pageTitle font-big" style="${ssrRenderStyle({ "align-self": "flex-start", "padding-left": "20px" })}">\u6280\u8853\u5718\u968A</label></div><div class="text-container" style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "padding": "0 0 10px 0", "justify-content": "space-around", "flex-wrap": "wrap", "flex": "1" })}">`);
  _push(ssrRenderComponent(_component_StaffNameCard, {
...
//# sourceMappingURL=staff-d4e7faff.mjs.map
