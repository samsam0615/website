...
import { defineComponent, ref, provide, watch, onMounted, onBeforeUnmount, toRef, inject, computed, Comment, markRaw, openBlock, createElementBlock, createElementVNode, renderSlot, normalizeProps, guardReactiveProps, resolveComponent, withCtx, createTextVNode, createVNode, useSSRContext } from 'vue';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_Meta, {
    name: "description",
    content: "\u71B1\u7DDA\u96FB\u8A71\uFF1A5542 7564 \u96FB\u90F5\u5730\u5740\uFF1Ainfo@eduairhk.com"
  }, null, _parent));
  _push(`<div class="bg" data-v-6ce83501>`);
  if ($data.isError) {
    _push(`<div style="${ssrRenderStyle({ "position": "fixed", "width": "400px", "height": "max-content", "background": "rgba(255, 236, 236, 0.95)", "z-index": "1", "top": "50%", "left": "50%", "max-width": "75%", "max-height": "40%", "transform": "translate(-50%, -50%)", "padding": "25px" })}" data-v-6ce83501><div style="${ssrRenderStyle({ "font-size": "20px" })}" data-v-6ce83501>Failed Sending Form</div><div style="${ssrRenderStyle({ "font-size": "16px", "padding": "10px 0" })}" data-v-6ce83501> The contact form functionality has encountered an issue. Please utilize email to get in touch with us. </div></div>`);
  } else {
    _push(`<!---->`);
  }
  if ($data.isSuccess) {
    _push(`<div style="${ssrRenderStyle({ "position": "fixed", "width": "400px", "height": "max-content", "background": "rgba(236, 255, 236, 0.95)", "z-index": "1", "top": "50%", "left": "50%", "max-width": "75%", "max-height": "40%", "transform": "translate(-50%, -50%)", "padding": "25px" })}" data-v-6ce83501><div style="${ssrRenderStyle({ "font-size": "20px" })}" data-v-6ce83501>Send Sucessfully </div><div style="${ssrRenderStyle({ "font-size": "16px", "padding": "10px 0" })}" data-v-6ce83501></div></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<div class="pageContent-container" data-v-6ce83501><div class="text-container" data-v-6ce83501><div class="form" data-v-6ce83501><div style="${ssrRenderStyle({ "width": "100%", "background": "rgba( 255, 255, 255, 0.7   )", "padding": "30px", "flex": "1" })}" data-v-6ce83501><label class="pageTitle font-big" data-v-6ce83501>\u7ACB\u5373\u806F\u7D61 EduAIR<br data-v-6ce83501></label><br data-v-6ce83501><form id="contactform" style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column" })}" data-v-6ce83501><input${ssrRenderAttr("value", $data.name)} class="font-mini" type="text" id="name" name="name" placeholder="\u59D3\u540D\uFF08\u5FC5\u586B\uFF09" autocomplete="off" required data-v-6ce83501><input${ssrRenderAttr("value", $data.email)} class="font-mini" type="text" id="email" name="email" placeholder="\u96FB\u90F5\uFF08\u5FC5\u586B\uFF09" autocomplete="off" required data-v-6ce83501><textarea class="font-mini" placeholder="\u5167\u5BB9\uFF08\u5FC5\u586B\uFF09" name="message" id="message" data-v-6ce83501>${ssrInterpolate($data.content)}</textarea><div class="row" style="${ssrRenderStyle({ "display": "flex", "justify-content": "space-between" })}" data-v-6ce83501><input class="font-mini" type="text" id="phone" name="phone" placeholder="\u806F\u7D61\u96FB\u8A71" autocomplete="off" data-v-6ce83501><input class="font-mini" type="text" id="contactformOrganization" name="organization" placeholder="\u6A5F\u69CB/\u516C\u53F8\u540D\u7A31" autocomplete="off" data-v-6ce83501></div><div style="${ssrRenderStyle({ "justify-content": "center", "display": "flex" })}" data-v-6ce83501><button data-v-6ce83501>\u63D0\u4EA4</button><button data-v-6ce83501>\u91CD\u7F6E</button></div></form></div></div><div style="${ssrRenderStyle({ "display": "flex", "align-self": "center", "flex-direction": "column", "max-width": "100%", "justify-content": "center", "align-items": "center", "padding": "20px 0", "width": "max-content" })}" data-v-6ce83501><div style="${ssrRenderStyle({ "border-radius": "5px", "overflow": "hidden", "width": "400px", "height": "300px", "max-width": "100%" })}" data-v-6ce83501>`);
  ...
  _push(`</div><div style="${ssrRenderStyle({ "width": "400px", "max-width": "100%", "padding": "20px", "line-height": "30px", "background": "rgba(255,255,255,0.6)", "margin": "20px 0 5px", "border-radius": "10px", "display": "flex", "align-items": "center" })}" data-v-6ce83501> \u806F\u7D61\u96FB\u8A71\uFF1A+852 5542 7564<br data-v-6ce83501> \u806F\u7D61\u96FB\u90F5\uFF1Ainfo@eduairhk.com<br data-v-6ce83501> \u5730\u5740\uFF1A\u79D1\u5B78\u571216W\u68DF2\u6A13237\u5BA4 </div></div></div></div></div><!--]-->`);
}
...
const contact = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-6ce83501"]]);

export { contact as default };
//# sourceMappingURL=contact-2295a801.mjs.map
