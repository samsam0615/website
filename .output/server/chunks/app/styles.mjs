...
const styles = {
  ...
  "pages/courses.vue": () => import('./_nuxt/courses-styles.bd6cf9a8.mjs').then(interopDefault),
  ...
  "pages/event/4.vue": () => import('./_nuxt/4-styles.99f2eb40.mjs').then(interopDefault),
