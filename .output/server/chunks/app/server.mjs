import { version, getCurrentInstance, inject, ref, watchEffect, watch, defineComponent, computed, h, resolveComponent, useSSRContext, createApp, reactive, unref, hasInjectionContext, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, shallowReactive, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, mergeProps, nextTick, Suspense, Transition, withCtx, createTextVNode } from 'vue';
...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/cuhk-icar-c5cf9615.mjs').then((m) => m.default || m)
  },
  {
    name: "cuhk-iport",
    path: "/cuhk-iport",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/cuhk-iport-38644677.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-8724a41d.mjs').then((m) => m.default || m)
  },
  {
    name: "resource",
    path: "/resource",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/resource-9f66ceaa.mjs').then((m) => m.default || m)
  },
  {
    name: "staff",
    path: "/staff",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/staff-525e1a24.mjs').then((m) => m.default || m)
  },
  {
    name: "test",
    path: "/test",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/test-225d79cd.mjs').then((m) => m.default || m)
  }
];
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</li><li><a class="subMenuBtn"> 學習平台 </a><ul class="subMenu"><li><a href="https://beta.eduairhk.com" target="_blank"> iPort ePlatform </a></li></ul></li></ul></div>`);
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-9a1f7d25.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-4cbc086d.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-111fb402.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
