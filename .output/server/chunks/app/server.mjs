...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/4-229c5a11.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-5b400579.mjs').then((m) => m.default || m)
  },
  {
    name: "ishare",
    path: "/ishare",
...
const siteConfig_Eeyr9ytLpT = /* @__PURE__ */ defineNuxtPlugin({
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="logo-container" style="${ssrRenderStyle({ "position": "relative", "width": "180px", "height": "60px", "display": "flex", "justify-content": "center", "align-items": "center", "cursor": "pointer" })}"${_scopeId}><img${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "position": "relative", "height": "70%" })}"${_scopeId}><label class="title"${_scopeId}>愛動智</label></div>`);
      } else {
        return [
          createVNode("div", {
            class: "logo-container",
            style: { "position": "relative", "width": "180px", "height": "60px", "display": "flex", "justify-content": "center", "align-items": "center", "cursor": "pointer" }
          }, [
            createVNode("img", {
              src: _imports_0,
              style: { "position": "relative", "height": "70%" }
            }),
            createVNode("label", { class: "title" }, "愛動智")
          ])
        ];
      }
    }),
  ...
  _push(`<div style="${ssrRenderStyle({ "height": "60px", "width": "60px", "display": "flex", "justify-content": "center", "align-items": "center", "cursor": "pointer" })}"><img${ssrRenderAttr("src", _imports_1)} width="36" height="36" class="btn"></div></div><ul class="userMenu"><li><a class="subMenuBtn"> 關於我們 </a><ul class="subMenu"><li>`);
  ...
  _push(`</li><li>`);
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/staff" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` 公司架構 `);
      } else {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/ishare" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          createTextVNode(" iShare ")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`</li><li><a class="subMenuBtn"> 學習平台 </a><ul class="subMenu"><li><a href="https://iport.eduairhk.com" target="_blank"> iPort ePlatform </a></li><li><a href="https://ipython.eduairhk.com" target="_blank"> iPython <div class="border"> 敬請期待 </div></a></li><li><a href="https://itrain.eduairhk.com" target="_blank"> iTrain <div class="border"> 敬請期待 </div></a></li></ul></li></ul></div>`);
}
...
const ipxRuntime$2JRz3bUnCT = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$2JRz3bUnCT, defaults: void 0 }
};
const useImage = () => {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="container" data-v-75252dda><div class="footer" style="${ssrRenderStyle({})}" data-v-75252dda><div class="main" data-v-75252dda><label class="font-middle" data-v-75252dda>EduAIR 愛動智</label><a href="https://www.facebook.com/eduair" target="_blank" data-v-75252dda>`);
  _push(ssrRenderComponent(_component_nuxt_img, {
    src: "facebook3.png",
    height: "20px"
  }, null, _parent));
  _push(`<label class="font-mini" style="${ssrRenderStyle({ "padding": "0 10px" })}" data-v-75252dda>愛動智教育系統</label></a><a href="https://www.instagram.com/eduair_hk/" target="_blank" data-v-75252dda>`);
  _push(ssrRenderComponent(_component_nuxt_img, {
    src: "instagram3.png",
    height: "20px",
    style: {}
  }, null, _parent));
  _push(`<label class="font-mini" style="${ssrRenderStyle({ "padding": "0 10px" })}" data-v-75252dda>eduair_hk</label></a></div><div data-v-75252dda><label class="font-middle" data-v-75252dda>聯絡我們</label><label style="${ssrRenderStyle({ "padding": "4px 0" })}" data-v-75252dda>`);
  _push(ssrRenderComponent(_component_nuxt_img, {
    src: "call3.png",
    height: "18px",
    style: {}
  }, null, _parent));
  _push(`<label class="font-mini" style="${ssrRenderStyle({ "padding": "0 10px" })}" x-apple-data-detectors="off" data-v-75252dda>+852 5542 7564</label></label><label style="${ssrRenderStyle({ "padding": "4px 0" })}" data-v-75252dda>`);
  _push(ssrRenderComponent(_component_nuxt_img, {
    src: "mail3.png",
    height: "18px"
  }, null, _parent));
  _push(`<label class="font-mini" style="${ssrRenderStyle({ "padding": "0 10px" })}" data-v-75252dda>info@eduairhk.com</label></label><label style="${ssrRenderStyle({ "padding": "4px 0" })}" data-v-75252dda>`);
  _push(ssrRenderComponent(_component_nuxt_img, {
    src: "location3.png",
    height: "18px"
  }, null, _parent));
  _push(`<label class="font-mini" style="${ssrRenderStyle({ "padding": "0 10px" })}" data-v-75252dda>科學園16W棟2樓237室</label></label></div></div><div style="${ssrRenderStyle({ "padding": "15px 0" })}" data-v-75252dda> Copyright © EduAIR Systems Limited. </div></div><!--]-->`);
}
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-d798e9fc.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
